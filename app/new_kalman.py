...
class MovementModel:
    def __init__(self, initial_position_xy, velocity_xy, Ts, type="constant"):
        self.position_xy = np.array(initial_position_xy, dtype=float)
...
def simulate(points_t, value_count=1, plotting=False, initial_position_xy=(0, 0), velocity_xy=(1, 1)):
    # initialize Movement
    ...
    if plotting:
        ...
        for idx, s in enumerate(speaker_positions):
            color = 'rgbykkkkkkkkkkkk'
